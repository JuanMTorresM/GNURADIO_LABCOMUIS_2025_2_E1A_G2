...
class MISION3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MISION3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MISION3")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "MISION3")
        ...
        self._ka_range = qtgui.Range(0, 3, 10e-3, 1, 200)
        ...
        self._fc_range = qtgui.Range(50, 2.22e3, 1, 200, 200)
        ...
        self._ac_range = qtgui.Range(0, 500e-3, 10e-3, 250e-3, 200)
        self._ac_win = qtgui.RangeWidget(self._ac_range, self.set_ac, "ampitud portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fm_range = qtgui.Range(100, 20e3, 10e-3, 1e3, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Descargas/algomegustadeti_WY.wav', True)
        ...
        self._am_range = qtgui.Range(0, 1, 10e-3, 1, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(50, self.samp_rate)
...
def main(top_block_cls=MISION3, options=None):
